...
async function seedGallery() {
  ...
  console.log(`  Adding ${modernWoodenImages.length} modern wooden images...`);
  ...
  console.log(`  Adding ${classicWoodenImages.length} classic wooden images...`);
  ...
  // Add Aluminum images
  console.log(`  Adding ${aluminumImages.length} aluminum images...`);
  ...
  // Add Bedroom images
  console.log(`  Adding ${bedroomImages.length} bedroom images...`);
  ...
  console.log(`  Inserting ${galleryItems.length} gallery images...`);
  const result = await prisma.galleryImage.createMany({
    data: galleryItems,
  });

  console.log(`✅ Successfully seeded ${result.count} gallery images!`);
  console.log(`   - Modern Wooden: ${modernWoodenImages.length}`);
  console.log(`   - Classic Wooden: ${classicWoodenImages.length}`);
  console.log(`   - Aluminum: ${aluminumImages.length}`);
  console.log(`   - Bedrooms: ${bedroomImages.length}`);
}
