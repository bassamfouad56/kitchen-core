      ...
      <footer className="bg-background-elevated text-gray-light border-t border-gray-dark">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            {/* Showroom */}
            <div>
              <h3 className="text-green-vibrant text-sm tracking-wider mb-4 font-medium">
            ...
            <div>
              ...
              <a
                ...
                className="text-gray-light hover:text-green-primary transition-colors font-light inline-flex items-center gap-2 group text-sm"
              >
                <svg
          ...
          {/* Bottom Bar */}
          <div className="py-6 border-t border-gray-dark flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
