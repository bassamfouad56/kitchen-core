  ...
  const handlePlayPause = (id: number) => {
    ...
    if (video.paused) {
      ...
      Object.keys(videoRefs.current).forEach((key) => {
        ...
        if (vid && Number(key) !== id && !vid.paused) {
          vid.pause();
          setActiveVideo(null);
        }
      });
        ...
        <div className="text-center mb-20">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-light max-w-3xl mx-auto font-light leading-relaxed">
              Watch our kitchen transformations come to life. See the quality,
              precision, and attention to detail that defines Kitchen Core.
            </p>
          </motion.div>
        </div>
          ...
          <div className="bg-background-card border border-green-primary/30 p-12">
            ...
            >
              ...
              <p className="text-gray-light text-lg font-light leading-relaxed mb-8 max-w-2xl mx-auto">
                Experience the perfect blend of durability and elegance. Our
                aluminum structures and PVC finishes ensure your kitchen stays
