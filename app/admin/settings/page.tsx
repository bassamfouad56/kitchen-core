...
export default function SettingsPage() {
  ...
  const fetchSettings = async () => {
    try {
      ...
      setSettings(data)
      setPartnerships(data.partnerships && data.partnerships.length > 0 ? data.partnerships : [''])
      setSeoKeywords(data.seoKeywords && data.seoKeywords.length > 0 ? data.seoKeywords : [''])
      setLoading(false)
    } catch (err) {
  ...
  const removePartnership = (index: number) => setPartnerships(partnerships.filter((_, i) => i !== index))
  ...
  const removeKeyword = (index: number) => setSeoKeywords(seoKeywords.filter((_, i) => i !== index))
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="border border-gray-dark p-6">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="siteTitle" className="block text-sm font-medium text-gray-light mb-2">
                  Site Title *
                </label>
                <input
                  type="text"
          ...
          <div className="border border-gray-dark p-6">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="heroTagline" className="block text-sm font-medium text-gray-light mb-2">
                  Tagline
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="heroHeading" className="block text-sm font-medium text-gray-light mb-2">
                  Heading
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="heroSubheading" className="block text-sm font-medium text-gray-light mb-2">
                  Subheading
                </label>
                <textarea
                  id="heroSubheading"
          ...
          <div className="border border-gray-dark p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="showroomAddress" className="block text-sm font-medium text-gray-light mb-2">
                  Showroom Address
                </label>
                <textarea
                  id="showroomAddress"
          ...
          <div className="border border-gray-dark p-6">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="instagramUrl" className="block text-sm font-medium text-gray-light mb-2">
                  Instagram URL
                </label>
                <input
                  type="url"
              ...
              <div>
                <label htmlFor="pinterestUrl" className="block text-sm font-medium text-gray-light mb-2">
                  Pinterest URL
                </label>
                <input
                  type="url"
              ...
              <div>
                <label htmlFor="linkedinUrl" className="block text-sm font-medium text-gray-light mb-2">
                  LinkedIn URL
                </label>
                <input
                  type="url"
              ...
              <div>
                <label htmlFor="houzzUrl" className="block text-sm font-medium text-gray-light mb-2">
                  Houzz URL
                </label>
                <input
                  type="url"
          ...
          <div className="border border-gray-dark p-6">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="seoDescription" className="block text-sm font-medium text-gray-light mb-2">
                  Meta Description
                </label>
                <textarea
                  id="seoDescription"
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="block text-sm font-medium text-gray-light">SEO Keywords</label>
                  <button
                    type="button"
                    onClick={addKeyword}
                    className="text-sm text-green-primary hover:text-green-vibrant"
